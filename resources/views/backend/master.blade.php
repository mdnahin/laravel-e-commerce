                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="{{ url('/home') }}">
                                    <i class="fi-air-play"></i> Dashboard </span>
                                </a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ url('/') }}">
                                
                                    <i class="fi-globe"></i> <!--<span class="badge badge-danger badge-pill float-right">7</span> -->  <span>  Visit Site </span>
                                </a>
                            </li>

                            <li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Header </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ url('/fav-icon') }}">Fav-icon</a></li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ url('/slider') }}">Create Slide</a></li>
                                    <li><a href="{{ url('/all-slide') }}">All Slide</a></li>
                                    <li><a href="{{ url('/topbar') }}">Topbar</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i> <span> SubCategory </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ url('/add-subcategory') }}">Add SubCategory</a></li>
                                    <li><a href="{{ url('/view-subcategory') }}">View SubCategory</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="{{ url('/view-coupon') }}">All Coupon</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="{{ url('/testimonial') }}">
                                    <i class="fi-command"></i> <span> Testimonial </span>
                                </a>
                            </li>

                            <li>
                                <a href="javascript: void(0);"><i class="fi-command"></i><span> Footer </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ url('/footer-one') }}">Footer 1</a></li>
                                    <li><a href="{{ url('/footer-two') }}">Footer 2</a></li>
                                    <li><a href="{{ url('/footer-three') }}">Footer 3</a></li>
