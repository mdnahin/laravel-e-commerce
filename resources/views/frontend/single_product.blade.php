                ...
                <div class="col-lg-6">
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            <div class="item">
                                <img src="{{ url('/img/thumbnail') }}/{{ $product->product_thumbnail ?? ''}}" alt="{{ $product->product_thumbnail ?? ''}}">
                            </div>
                            @foreach($product_gallery as $pro_gallery)
                            <div class="item">
                                <img src="{{ url('/img/gallery') }}/{{ $pro_gallery->product_gallery ?? ''}}" alt="">
                            </div>
                           @endforeach
                        </div>
                        <div class="product-thumbnil-active  owl-carousel">
                            ...
                            @foreach($product_gallery as $items_gallery)
                            <div class="item">
                                <img src="{{ url('/img/gallery') }}/{{ $items_gallery->product_gallery ?? ''}}" alt="">
                            </div>
                           @endforeach
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="product-single-content">
                        ...
                        <div class="rating-wrap fix">
                           ...
                           <ul style="float:left;position:absolute;left:320px;z-index:1">
                                @for($i=1;$i<=$total_rate;$i++)
                                <li><i class="fa fa-star" style="color:red"></i></li>
                                @endfor
                           ...
                           <ul class="rating pull-right">
                                ...
                                <li><i class="fa fa-star" style="color:black"></i></li>
                                <li><i class="fa fa-star" style="color:black"></i></li>
                                <li>( {{ $total_rate ?? '0' }} Customar Review)</li>  
                            </ul>
                        </div>
                        <p>{{ Str::limit($product->product_summery,200) }}</p>
                        ...
                        <ul class="cetagory">
                            <li>Categories:</li>
                            <li><a href="#">{{ $product->get_category->category_name ?? '' }}</a></li>
                        </ul>
                        <ul class="socil-icon">
                            <li>Share :</li>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="featured-product-wrap">
                        <div class="featured-product-img">
                            <img src="{{ url('/img/thumbnail') }}/{{ $rel_pro->product_thumbnail ?? ''}}" alt="">
                        </div>
                        <div class="featured-product-content">
                            <div class="row">
                                <div class="col-7">
                                    <h3><a href="{{ route('SingleProduct',$rel_pro->slug) }}">{{ $rel_pro->product_name }}</a></h3>
                                    <p>${{ $rel_pro->product_price }}</p>
                                </div>
